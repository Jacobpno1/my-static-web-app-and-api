...
Invoke-Expression "& $sqlPackage /a:publish /tcs:""Data Source=$server.database.windows.net;Initial Catalog=my-static-db;UID=$username;PWD=$PlainTextPassword"" /sf:$dacpac"